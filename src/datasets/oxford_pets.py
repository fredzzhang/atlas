...
class OxfordIIITPet:
    def __init__(self,
                 ...
                 batch_size=32,
                 num_workers=16):
        self.train_dataset = PytorchOxfordIIITPet(location, 'trainval', transform=preprocess, download=True)
        ...
        self.test_dataset = PytorchOxfordIIITPet(location, 'test', transform=preprocess, download=True)
...
class PytorchOxfordIIITPet(VisionDataset):
    ...
    def __getitem__(self, idx: int) -> Tuple[Any, Any]:
        ...
        # return idx, image, target, self._images[idx].name
        return image, target
