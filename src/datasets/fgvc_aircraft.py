...
class FGVCAircraftBase:
    def __init__(self,
                 ...
                 batch_size=32,
                 num_workers=16):
        self.train_dataset = PyTorchFGVCAircraft(location, "train", transform=preprocess, download=True)
...
class FGVCAircraft(FGVCAircraftBase):
    def __init__(self,
                 preprocess,
                 location=os.path.expanduser('~/data'),
                 batch_size=32,
...
class PyTorchFGVCAircraft(VisionDataset):
    ...
    def __getitem__(self, idx) -> Tuple[Any, Any]:
        ...
        # return idx, image, label, image_file
        return image, label
