...
class Flowers102Base:
    def __init__(self,
                 ...
                 batch_size=32,
                 num_workers=16):
        self.train_dataset = PyTorchFlowers102(location, "train", transform=preprocess, download=True)
        ...
        self.test_dataset = PyTorchFlowers102(location, test_split, transform=preprocess, download=True)
...
class Flowers102(Flowers102Base):
    def __init__(self,
                 preprocess,
                 location=os.path.expanduser('~/data'),
                 batch_size=32,
...
class Flowers102Val(Flowers102Base):
    def __init__(self,
                 preprocess,
                 location=os.path.expanduser('~/data'),
                 batch_size=32,
...
class PyTorchFlowers102(VisionDataset):
    ...
    def __getitem__(self, idx) -> Tuple[Any, Any]:
        ...
        # return idx, image, label, image_file.name
        return image, label
